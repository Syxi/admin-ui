<template>
  <div class="workflow-definition-edit">
    <div class="flex justify-between items-center mb-4">
      <h1 class="text-xl font-bold">编辑流程定义</h1>
    ...
    <el-form :model="formData" :rules="rules" ref="formRef" label-width="120px" class="mb-4">
      ...
      <el-form-item label="流程Key" prop="processKey" disabled>
...
const handleSubmit = async () => {
  ...
  await formRef.value.validate(async (valid) => {
    if (valid) {
      try {
        await workflowApi.definition.updateDefinition(formData);
